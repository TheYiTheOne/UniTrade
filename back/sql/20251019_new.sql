...
-- 角色表数据（更新时间修改为2025-10-18 20:00:00）
INSERT INTO roles (role_name, create_time, update_time) VALUES
                                                            ('系统管理员', '2025-10-18 20:00:00', '2025-10-18 20:00:00'),
                                                            ('经理', '2025-10-18 20:00:00', '2025-10-18 20:00:00'),
                                                            ('店长', '2025-10-18 20:00:00', '2025-10-18 20:00:00'),
                                                            ('店员', '2025-10-18 20:00:00', '2025-10-18 20:00:00');

-- 权限表数据（新增8个权限）
INSERT INTO permissions (permission_name, create_time, update_time) VALUES
                                                                        ('VIEW_DATA', '2025-10-18 20:00:00', '2025-10-18 20:00:00'),
                                                                        ('OPEN_ORDER', '2025-10-18 20:00:00', '2025-10-18 20:00:00'),
                                                                        ('AUDIT', '2025-10-18 20:00:00', '2025-10-18 20:00:00'),
                                                                        ('RECEIVE_PAYMENT', '2025-10-18 20:00:00', '2025-10-18 20:00:00'),
                                                                        ('RETURN_GOODS', '2025-10-18 20:00:00', '2025-10-18 20:00:00'),
                                                                        ('INVENTORY_IN', '2025-10-18 20:00:00', '2025-10-18 20:00:00'),
                                                                        ('TRANSFER_STOCK', '2025-10-18 20:00:00', '2025-10-18 20:00:00'),
                                                                        ('VIEW_USERS', '2025-10-18 20:00:00', '2025-10-18 20:00:00'),
                                                                        ('EDIT_USERS', '2025-10-18 20:00:00', '2025-10-18 20:00:00');

-- 角色权限表数据（多对多关系）
INSERT INTO role_permission (role_id, permission_id, create_time, update_time) VALUES
                                                                                   -- 系统管理员拥有所有权限（1-9）
                                                                                   (1, 1, '2025-10-18 20:00:00', '2025-10-18 20:00:00'),
                                                                                   (1, 2, '2025-10-18 20:00:00', '2025-10-18 20:00:00'),
                                                                                   (1, 3, '2025-10-18 20:00:00', '2025-10-18 20:00:00'),
                                                                                   (1, 4, '2025-10-18 20:00:00', '2025-10-18 20:00:00'),
                                                                                   (1, 5, '2025-10-18 20:00:00', '2025-10-18 20:00:00'),
                                                                                   (1, 6, '2025-10-18 20:00:00', '2025-10-18 20:00:00'),
                                                                                   (1, 7, '2025-10-18 20:00:00', '2025-10-18 20:00:00'),
                                                                                   (1, 8, '2025-10-18 20:00:00', '2025-10-18 20:00:00'),
                                                                                   (1, 9, '2025-10-18 20:00:00', '2025-10-18 20:00:00'),
                                                                                   -- 经理拥有前7个权限（1-7）
                                                                                   (2, 1, '2025-10-18 20:00:00', '2025-10-18 20:00:00'),
                                                                                   (2, 2, '2025-10-18 20:00:00', '2025-10-18 20:00:00'),
                                                                                   (2, 3, '2025-10-18 20:00:00', '2025-10-18 20:00:00'),
                                                                                   (2, 4, '2025-10-18 20:00:00', '2025-10-18 20:00:00'),
                                                                                   (2, 5, '2025-10-18 20:00:00', '2025-10-18 20:00:00'),
                                                                                   (2, 6, '2025-10-18 20:00:00', '2025-10-18 20:00:00'),
                                                                                   (2, 7, '2025-10-18 20:00:00', '2025-10-18 20:00:00'),
                                                                                   -- 店长拥有前5个权限（1-5）
                                                                                   (3, 1, '2025-10-18 20:00:00', '2025-10-18 20:00:00'),
                                                                                   (3, 2, '2025-10-18 20:00:00', '2025-10-18 20:00:00'),
                                                                                   (3, 3, '2025-10-18 20:00:00', '2025-10-18 20:00:00'),
                                                                                   (3, 4, '2025-10-18 20:00:00', '2025-10-18 20:00:00'),
                                                                                   (3, 5, '2025-10-18 20:00:00', '2025-10-18 20:00:00'),
                                                                                   -- 店员拥有前2个权限（1-2）
                                                                                   (4, 1, '2025-10-18 20:00:00', '2025-10-18 20:00:00'),
                                                                                   (4, 2, '2025-10-18 20:00:00', '2025-10-18 20:00:00');
...
-- 库存表数据（新增product_name和warehouse_name字段）
INSERT INTO inventory (product_id, product_name, warehouse_id, warehouse_name, quantity, create_time, update_time) VALUES
                                                                                                                       (1, '苹果 iPhone 15 Pro 手机 256G', 1, '北京中央仓库', 50, '2025-01-20 10:15:00', '2025-06-25 14:30:00'),
                                                                                                                       (2, '华为 Mate 60 Pro 5G手机', 2, '上海浦东仓库', 30, '2025-01-25 11:30:00', '2025-07-30 16:45:00'),
                                                                                                                       (3, '小米 14 Ultra 拍照手机', 3, '广州天河仓库', 40, '2025-02-10 12:45:00', '2025-08-15 09:00:00'),
                                                                                                                       (4, '三星 S24 Ultra 智能手机', 4, '深圳南山仓库', 25, '2025-02-18 13:20:00', '2025-09-10 11:15:00'),
                                                                                                                       (5, '苹果 AirPods Pro 2 无线耳机', 5, '成都武侯仓库', 60, '2025-03-15 14:35:00', '2025-10-12 13:30:00'),
                                                                                                                       (6, '索尼 WH-1000XM5 降噪耳机', 6, '南京鼓楼仓库', 35, '2025-03-22 15:50:00', '2025-09-25 15:45:00'),
                                                                                                                       (7, '华为 FreeBuds Pro 3 蓝牙耳机', 7, '杭州西湖仓库', 45, '2025-04-08 09:05:00', '2025-09-18 17:00:00'),
                                                                                                                       (8, '苹果 MacBook Air M2 笔记本电脑', 8, '武汉江汉仓库', 20, '2025-04-15 10:20:00', '2025-10-10 10:15:00'),
                                                                                                                       (9, '华为 MateBook 14 轻薄笔记本', 9, '西安雁塔仓库', 55, '2025-05-12 11:35:00', '2025-10-15 12:30:00'),
                                                                                                                       (10, '联想 ThinkPad X1 商务电脑', 10, '重庆渝北仓库', 30, '2025-05-20 12:50:00', '2025-10-12 14:45:00'),
                                                                                                                       (11, '苹果 iPad Air 5 平板电脑', 11, '北京朝阳分仓', 40, '2025-06-10 13:25:00', '2025-09-12 16:00:00'),
                                                                                                                       (12, '华为 MatePad Pro 13.2 平板', 12, '上海虹桥分仓', 50, '2025-06-18 14:40:00', '2025-09-20 09:15:00'),
                                                                                                                       (13, '小米平板 6 Max 大屏平板', 13, '广州番禺分仓', 35, '2025-07-10 15:55:00', '2025-10-08 11:30:00'),
                                                                                                                       (14, '苹果 Watch Series 9 智能手表', 14, '深圳宝安分仓', 25, '2025-07-18 16:10:00', '2025-10-12 13:45:00'),
                                                                                                                       (15, '华为 Watch GT4 运动手表', 15, '成都高新分仓', 45, '2025-08-12 08:25:00', '2025-10-10 15:00:00'),
                                                                                                                       (16, '任天堂 Switch OLED 游戏机', 16, '南京江宁分仓', 60, '2025-08-20 09:40:00', '2025-10-08 17:15:00'),
                                                                                                                       (17, '索尼 PS5 Slim 游戏主机', 17, '杭州滨江分仓', 30, '2025-09-08 10:55:00', '2025-10-15 10:30:00'),
                                                                                                                       (18, '小米手环 8 Pro 智能手环', 18, '武汉光谷分仓', 40, '2025-09-15 12:10:00', '2025-10-12 12:45:00'),
                                                                                                                       (19, '佳能 EOS R50 微单相机', 19, '西安高新分仓', 20, '2025-10-05 13:25:00', '2025-10-16 15:00:00'),
                                                                                                                       (20, '大疆 Mini 4 Pro 无人机', 20, '重庆江北分仓', 35, '2025-10-10 14:40:00', '2025-10-17 17:15:00');

-- 销售单表数据 (type: 0-批发, 1-零售; status: 0-草稿,1-已审核,2-已收款,3-已退货)（新增customer_name, product_name, warehouse_name字段）
INSERT INTO orders (customer_id, customer_name, product_id, product_name, warehouse_id, warehouse_name, quantity, type, total_price, status, create_time, update_time) VALUES
                                                                                                                                                                           (1, '北京华联超市', 1, '苹果 iPhone 15 Pro 手机 256G', 1, '北京中央仓库', 5, 0, 39000.00, 2, '2025-02-05 09:15:00', '2025-02-10 14:30:00'),
                                                                                                                                                                           (11, '张三', 2, '华为 Mate 60 Pro 5G手机', 2, '上海浦东仓库', 1, 1, 6999.00, 2, '2025-02-12 10:20:00', '2025-02-15 16:45:00'),
                                                                                                                                                                           (2, '上海联华连锁', 3, '小米 14 Ultra 拍照手机', 3, '广州天河仓库', 10, 0, 45000.00, 1, '2025-03-08 11:25:00', '2025-03-12 09:10:00'),
                                                                                                                                                                           (12, '李四', 4, '三星 S24 Ultra 智能手机', 4, '深圳南山仓库', 1, 1, 7999.00, 2, '2025-03-15 13:40:00', '2025-03-18 11:35:00'),
                                                                                                                                                                           (3, '广州友谊商店', 5, '苹果 AirPods Pro 2 无线耳机', 5, '成都武侯仓库', 20, 0, 31000.00, 2, '2025-04-10 15:55:00', '2025-04-15 13:50:00'),
                                                                                                                                                                           (13, '王五', 6, '索尼 WH-1000XM5 降噪耳机', 6, '南京鼓楼仓库', 1, 1, 2599.00, 2, '2025-04-18 08:30:00', '2025-04-20 15:05:00'),
                                                                                                                                                                           (4, '深圳天虹商场', 7, '华为 FreeBuds Pro 3 蓝牙耳机', 7, '杭州西湖仓库', 15, 0, 15750.00, 1, '2025-05-05 10:45:00', '2025-05-08 16:20:00'),
                                                                                                                                                                           (14, '赵六', 8, '苹果 MacBook Air M2 笔记本电脑', 8, '武汉江汉仓库', 1, 1, 9999.00, 0, '2025-05-12 12:00:00', '2025-05-12 12:00:00'),
                                                                                                                                                                           (5, '成都伊藤洋华堂', 9, '华为 MateBook 14 轻薄笔记本', 9, '西安雁塔仓库', 8, 0, 50400.00, 2, '2025-06-08 14:15:00', '2025-06-12 12:50:00'),
                                                                                                                                                                           (15, '钱七', 10, '联想 ThinkPad X1 商务电脑', 10, '重庆渝北仓库', 1, 1, 7999.00, 2, '2025-06-15 16:30:00', '2025-06-18 14:05:00'),
                                                                                                                                                                           (6, '南京金鹰国际', 11, '苹果 iPad Air 5 平板电脑', 11, '北京朝阳分仓', 12, 0, 49200.00, 1, '2025-07-03 09:45:00', '2025-07-08 15:40:00'),
                                                                                                                                                                           (16, '孙八', 12, '华为 MatePad Pro 13.2 平板', 12, '上海虹桥分仓', 1, 1, 5499.00, 2, '2025-07-10 11:00:00', '2025-07-12 17:15:00'),
                                                                                                                                                                           (7, '杭州银泰百货', 13, '小米平板 6 Max 大屏平板', 13, '广州番禺分仓', 18, 0, 61200.00, 2, '2025-08-05 13:15:00', '2025-08-10 09:30:00'),
                                                                                                                                                                           (17, '周九', 14, '苹果 Watch Series 9 智能手表', 14, '深圳宝安分仓', 1, 1, 3199.00, 2, '2025-08-12 15:30:00', '2025-08-15 11:45:00'),
                                                                                                                                                                           (8, '武汉武商集团', 15, '华为 Watch GT4 运动手表', 15, '成都高新分仓', 25, 0, 28750.00, 1, '2025-09-08 08:45:00', '2025-09-12 13:00:00'),
                                                                                                                                                                           (18, '吴十', 16, '任天堂 Switch OLED 游戏机', 16, '南京江宁分仓', 1, 1, 2599.00, 3, '2025-09-15 10:00:00', '2025-09-20 14:15:00'),
                                                                                                                                                                           (9, '西安开元商城', 17, '索尼 PS5 Slim 游戏主机', 17, '杭州滨江分仓', 6, 0, 20400.00, 2, '2025-10-03 12:15:00', '2025-10-08 15:30:00'),
                                                                                                                                                                           (19, '郑十一', 18, '小米手环 8 Pro 智能手环', 18, '武汉光谷分仓', 1, 1, 599.00, 2, '2025-10-10 14:30:00', '2025-10-12 16:45:00'),
                                                                                                                                                                           (10, '重庆新世纪百货', 19, '佳能 EOS R50 微单相机', 19, '西安高新分仓', 3, 0, 15300.00, 0, '2025-10-12 16:45:00', '2025-10-12 16:45:00'),
                                                                                                                                                                           (20, '王十二', 20, '大疆 Mini 4 Pro 无人机', 20, '重庆江北分仓', 1, 1, 5399.00, 1, '2025-10-15 09:00:00', '2025-10-16 10:15:00');

-- 用户表数据
INSERT INTO users (account, password, name, role_id, create_time, update_time) VALUES
    ('admin', '123456', '系统管理员', 1, '2025-10-18 20:00:00', '2025-10-18 20:00:00'),
    ('manager', '123456', '经理', 2, '2025-10-18 20:00:00', '2025-10-18 20:00:00'),
    ('storemanager', '123456', '店长', 3, '2025-10-18 20:00:00', '2025-10-18 20:00:00'),
    ('clerk', '123456', '店员', 4, '2025-10-18 20:00:00', '2025-10-18 20:00:00');